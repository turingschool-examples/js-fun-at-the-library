...
// var ...
var title = 'The Culinary Bro-Down Cookbook'
var pages = 256
...
var sequel = `${title}: Part 2 Electric Boogaloo`
...
if (isFavorite == true) {
  ...
  console.log(`I recently red the ${title}`);
}
...
var books = ['To Kill a Mockingbird', "The Hitchhiker's guid to the Galaxy", 'The Great Gatsby', 'Sapiens: A Brief History of Human Kind', 'THe Alchemist']
...
belowTwoHundred = [25, 68, 112, 45, 171, 89, 134, 52, 183, 37, 99, 156]
