...
describe('book.js', function() {
  ...
  it.skip('buildMainCharacter should be a function (make sure to add the function you create in book.js to the module.exports)', function() {
  ...
  it.skip('calculatePageCount should be a function (make sure to add the function you create in book.js to the module.exports)', function() {
